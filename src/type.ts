...
// > = CommitBase & {
//   [Field in Exclude<Fields, keyof CommitBase>]?:
//     | Field
//     | undefined
//     | null
//     | Field[];
...
interface Options {
   ...
   * null
   */
  mergePattern?: Pattern | undefined;
   ...
   * null
   */
  mergeCorrespondence?: Correspondence | undefined;
   ...
   * /^(\w*)(?:\(([\w\$\.\-\* ]*)\))?\: (.*)$/
   */
  headerPattern?: Pattern | undefined;
   ...
   * ['type', 'scope', 'subject']
   */
  headerCorrespondence?: Correspondence | undefined;
   ...
   */
  referenceActions?: Actions | undefined;
   ...
   * ['#']
   */
  issuePrefixes?: Prefixes | undefined;
   ...
   * ['BREAKING CHANGE']
   */
  noteKeywords?: Keywords | undefined;
   ...
   * /^-(.*?)-$/
   */
  fieldPattern?: Pattern | undefined;
   ...
   */
  revertPattern?: Pattern | undefined;
   ...
   * ['header', 'hash']
   */
  revertCorrespondence?: Correspondence | undefined;
...
export type Parse = <T = CommitBase>(commit: string, options?: Options) => T;
export type { Options, CommitBase };
